...
macro_rules! misc_pallet_impls {
    () => {
        ...
        impl frame_system::Config for Runtime {
            ...
            type Lookup = sp_runtime::traits::AccountIdLookup<polymesh_primitives::AccountId, u64>;
...
macro_rules! runtime_apis {
    ($($extra:item)*) => {
        ...
        pub type Address = sp_runtime::MultiAddress<polymesh_primitives::AccountId, u64>;
