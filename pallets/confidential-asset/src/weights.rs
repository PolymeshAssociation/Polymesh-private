...
//! DATE: 2024-11-07, STEPS: `100`, REPEAT: 5, LOW RANGE: `[]`, HIGH RANGE: `[]`
...
impl pallet_confidential_asset::WeightInfo for SubstrateWeight {
    ...
    fn create_account() -> Weight {
        // Minimum execution time: 34_074 nanoseconds.
        Weight::from_ref_time(34_745_000)
    ...
    fn create_asset() -> Weight {
        ...
        Weight::from_ref_time(103_735_000)
    ...
    fn mint() -> Weight {
        // Minimum execution time: 316_624 nanoseconds.
        Weight::from_ref_time(324_519_000)
    ...
    // Proof: Babe EpochStart (max_values: Some(1), max_size: Some(8), added: 503, mode: MaxEncodedLen)
    fn burn() -> Weight {
        // Minimum execution time: 2_570_343 nanoseconds.
        Weight::from_ref_time(2_571_745_000)
    ...
    fn set_asset_frozen() -> Weight {
        // Minimum execution time: 22_312 nanoseconds.
        Weight::from_ref_time(22_642_000)
    ...
    fn set_account_asset_frozen() -> Weight {
        // Minimum execution time: 40_696 nanoseconds.
        Weight::from_ref_time(41_127_000)
            .saturating_add(DbWeight::get().reads(3))
            .saturating_add(DbWeight::get().writes(1))
    }
    // Storage: Identity KeyRecords (r:1 w:0)
    ...
    fn apply_incoming_balance() -> Weight {
        ...
        Weight::from_ref_time(62_919_000)
            .saturating_add(DbWeight::get().reads(4))
            .saturating_add(DbWeight::get().writes(2))
    }
    // Storage: Identity KeyRecords (r:1 w:0)
    ...
    fn apply_incoming_balances(b: u32) -> Weight {
        ...
        Weight::from_ref_time(114_131_099)
            // Standard Error: 144_197
            .saturating_add(Weight::from_ref_time(28_145_144).saturating_mul(b.into()))
            .saturating_add(DbWeight::get().reads(3))
    ...
    fn create_venue() -> Weight {
        ...
        Weight::from_ref_time(18_996_000)
            .saturating_add(DbWeight::get().reads(2))
            .saturating_add(DbWeight::get().writes(3))
    }
    // Storage: Identity KeyRecords (r:1 w:0)
    ...
    fn set_venue_filtering() -> Weight {
        ...
        Weight::from_ref_time(21_440_000)
            .saturating_add(DbWeight::get().reads(2))
            .saturating_add(DbWeight::get().writes(1))
    }
    // Storage: Identity KeyRecords (r:1 w:0)
    ...
    fn allow_venues(v: u32) -> Weight {
        ...
        Weight::from_ref_time(17_705_594)
            // Standard Error: 4_132
            .saturating_add(Weight::from_ref_time(1_560_816).saturating_mul(v.into()))
            .saturating_add(DbWeight::get().reads(2))
    ...
    fn disallow_venues(v: u32) -> Weight {
        ...
        Weight::from_ref_time(17_206_487)
            // Standard Error: 4_377
            .saturating_add(Weight::from_ref_time(1_517_534).saturating_mul(v.into()))
            .saturating_add(DbWeight::get().reads(2))
            .saturating_add(DbWeight::get().writes((1_u64).saturating_mul(v.into())))
    }
    // Storage: Identity KeyRecords (r:1 w:0)
    ...
    fn add_transaction(l: u32, m: u32) -> Weight {
        // Minimum execution time: 239_640 nanoseconds.
        Weight::from_ref_time(239_719_000)
            // Standard Error: 732_533
            .saturating_add(Weight::from_ref_time(190_693_105).saturating_mul(l.into()))
            // Standard Error: 91_703
            .saturating_add(Weight::from_ref_time(1_231_109).saturating_mul(m.into()))
            .saturating_add(DbWeight::get().reads(3))
    ...
    fn sender_affirm_transaction(a: u32) -> Weight {
        // Minimum execution time: 209_222 nanoseconds.
        Weight::from_ref_time(184_612_681)
            // Standard Error: 453_357
            .saturating_add(Weight::from_ref_time(37_534_122).saturating_mul(a.into()))
    ...
    fn sender_affirm_transaction_batch(l: u32) -> Weight {
        // Minimum execution time: 5_688_133 nanoseconds.
        Weight::from_ref_time(2_520_266_572)
            // Standard Error: 690_074
            .saturating_add(Weight::from_ref_time(799_859_162).saturating_mul(l.into()))
            .saturating_add(DbWeight::get().reads(7))
    ...
    fn receiver_affirm_transaction() -> Weight {
        // Minimum execution time: 222_207 nanoseconds.
        Weight::from_ref_time(292_088_000)
            .saturating_add(DbWeight::get().reads(6))
            .saturating_add(DbWeight::get().writes(2))
    }
    // Storage: Identity KeyRecords (r:1 w:0)
    ...
    fn mediator_affirm_transaction() -> Weight {
        // Minimum execution time: 200_476 nanoseconds.
        Weight::from_ref_time(235_662_000)
    ...
    fn execute_transaction(l: u32) -> Weight {
        // Minimum execution time: 282_199 nanoseconds.
        Weight::from_ref_time(283_011_000)
            // Standard Error: 465_102
            .saturating_add(Weight::from_ref_time(255_441_222).saturating_mul(l.into()))
            .saturating_add(DbWeight::get().reads(6))
    ...
    fn reject_transaction(l: u32) -> Weight {
        // Minimum execution time: 238_547 nanoseconds.
        Weight::from_ref_time(239_229_000)
            // Standard Error: 527_192
            .saturating_add(Weight::from_ref_time(216_116_507).saturating_mul(l.into()))
            .saturating_add(DbWeight::get().reads(5))
    ...
    fn batch_verify_sender_proofs() -> Weight {
        // Minimum execution time: 7_933_257 nanoseconds.
        Weight::from_ref_time(8_081_454_000)
    }
    /// The range of component `p` is `[0, 256]`.
    fn verify_sender_proofs(p: u32) -> Weight {
        // Minimum execution time: 781 nanoseconds.
        Weight::from_ref_time(4_177_373_961)
            // Standard Error: 1_161_213
            .saturating_add(Weight::from_ref_time(568_802_445).saturating_mul(p.into()))
    }
    /// The range of component `a` is `[0, 100]`.
    fn verify_one_sender_proof(a: u32) -> Weight {
        // Minimum execution time: 3_974_167 nanoseconds.
        Weight::from_ref_time(4_375_063_591)
            // Standard Error: 320_658
            .saturating_add(Weight::from_ref_time(4_365_397).saturating_mul(a.into()))
    }
    // Storage: Identity KeyRecords (r:1 w:0)
    // Proof Skipped: Identity KeyRecords (max_values: None, max_size: None, mode: Measured)
    // Storage: ConfidentialAsset RngNonce (r:1 w:1)
    ...
    fn move_assets_no_assets(m: u32) -> Weight {
        ...
        Weight::from_ref_time(307_483_535)
            // Standard Error: 198_030
            .saturating_add(Weight::from_ref_time(41_954_027).saturating_mul(m.into()))
            .saturating_add(DbWeight::get().reads(4))
    ...
    fn move_assets_one_batch(a: u32) -> Weight {
        // Minimum execution time: 58_079 nanoseconds.
        Weight::from_ref_time(58_620_000)
            // Standard Error: 611_421
            .saturating_add(Weight::from_ref_time(282_040_626).saturating_mul(a.into()))
            .saturating_add(DbWeight::get().reads(6))
    ...
    fn elgamal_wasm() -> Weight {
        // Minimum execution time: 190_647 nanoseconds.
        Weight::from_ref_time(191_390_000)
    }
    fn elgamal_host() -> Weight {
        // Minimum execution time: 36_168 nanoseconds.
        Weight::from_ref_time(36_359_000)
    }
}
