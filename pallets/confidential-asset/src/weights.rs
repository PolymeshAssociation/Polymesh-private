...
impl crate::WeightInfo for SubstrateWeight {
    ...
    // Storage: ConfidentialAsset ConfidentialAccountBalance (r:1 w:1)
    // Proof Skipped: ConfidentialAsset ConfidentialAccountBalance (max_values: None, max_size: None, mode: Measured)
    // Storage: ConfidentialAsset ConfidentialAccountDid (r:1 w:1)
    // Proof Skipped: ConfidentialAsset ConfidentialAccountDid (max_values: None, max_size: None, mode: Measured)
    ...
    // Storage: Identity KeyRecords (r:1 w:0)
    // Proof Skipped: Identity KeyRecords (max_values: None, max_size: None, mode: Measured)
    // Storage: ConfidentialAsset MediatorConfidentialAccounts (r:0 w:1)
    // Proof Skipped: ConfidentialAsset MediatorConfidentialAccounts (max_values: None, max_size: None, mode: Measured)
    ...
    // Storage: Identity KeyRecords (r:1 w:0)
    // Proof Skipped: Identity KeyRecords (max_values: None, max_size: None, mode: Measured)
    // Storage: ConfidentialAsset ConfidentialAccountDid (r:1 w:0)
    // Proof Skipped: ConfidentialAsset ConfidentialAccountDid (max_values: None, max_size: None, mode: Measured)
    ...
    // Proof Skipped: ConfidentialAsset VenueAllowList (max_values: None, max_size: None, mode: Measured)
    // Storage: ConfidentialAsset ConfidentialAccountDid (r:2 w:0)
    // Proof Skipped: ConfidentialAsset ConfidentialAccountDid (max_values: None, max_size: None, mode: Measured)
