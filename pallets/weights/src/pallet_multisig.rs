...
impl pallet_multisig::WeightInfo for SubstrateWeight {
    ...
    fn create_multisig(i: u32) -> Weight {
        ...
        Weight::from_ref_time(39_688_945)
            // Standard Error: 32_147
            .saturating_add(Weight::from_ref_time(9_672_358).saturating_mul(i.into()))
    ...
    // Proof Skipped: MultiSig ProposalVoteCounts (max_values: None, max_size: None, mode: Measured)
    fn approve() -> Weight {
        // Minimum execution time: 49_843 nanoseconds.
        Weight::from_ref_time(50_936_000)
    ...
    fn execute_proposal() -> Weight {
        ...
        Weight::from_ref_time(31_840_000)
    ...
    fn reject() -> Weight {
        ...
        Weight::from_ref_time(56_096_000)
            .saturating_add(DbWeight::get().reads(9))
    ...
    fn accept_multisig_signer() -> Weight {
        ...
        Weight::from_ref_time(59_302_000)
    ...
    fn add_multisig_signers(i: u32) -> Weight {
        ...
        Weight::from_ref_time(35_311_983)
            // Standard Error: 39_212
            .saturating_add(Weight::from_ref_time(8_502_366).saturating_mul(i.into()))
    ...
    fn remove_multisig_signers(i: u32) -> Weight {
        ...
        Weight::from_ref_time(42_270_122)
            // Standard Error: 47_883
            .saturating_add(Weight::from_ref_time(7_528_797).saturating_mul(i.into()))
            .saturating_add(DbWeight::get().reads(4))
    ...
    fn add_multisig_signers_via_admin(i: u32) -> Weight {
        // Minimum execution time: 42_940 nanoseconds.
        Weight::from_ref_time(36_581_594)
            // Standard Error: 18_796
            .saturating_add(Weight::from_ref_time(8_904_571).saturating_mul(i.into()))
            .saturating_add(DbWeight::get().reads(8))
            .saturating_add(DbWeight::get().writes(2))
            .saturating_add(DbWeight::get().writes((2_u64).saturating_mul(i.into())))
    }
    ...
    fn remove_multisig_signers_via_admin(i: u32) -> Weight {
        ...
        Weight::from_ref_time(23_911_890)
            // Standard Error: 41_594
            .saturating_add(Weight::from_ref_time(8_813_067).saturating_mul(i.into()))
            .saturating_add(DbWeight::get().reads(6))
            .saturating_add(DbWeight::get().reads((2_u64).saturating_mul(i.into())))
            .saturating_add(DbWeight::get().writes(3))
            .saturating_add(DbWeight::get().writes((2_u64).saturating_mul(i.into())))
    ...
    fn change_sigs_required() -> Weight {
        // Minimum execution time: 30_067 nanoseconds.
        Weight::from_ref_time(30_687_000)
            .saturating_add(DbWeight::get().reads(6))
    ...
    fn remove_admin_via_admin() -> Weight {
        // Minimum execution time: 20_729 nanoseconds.
    ...
    fn remove_payer() -> Weight {
        ...
        Weight::from_ref_time(23_715_000)
            .saturating_add(DbWeight::get().reads(4))
            .saturating_add(DbWeight::get().writes(1))
    }
    // Storage: Identity KeyRecords (r:1 w:0)
    ...
    fn remove_payer_via_payer() -> Weight {
        ...
        Weight::from_ref_time(20_729_000)
            .saturating_add(DbWeight::get().reads(2))
            .saturating_add(DbWeight::get().writes(1))
    }
    // Storage: MultiSig MultiSigSignsRequired (r:1 w:0)
    ...
    fn join_identity() -> Weight {
        // Minimum execution time: 76_894 nanoseconds.
        Weight::from_ref_time(77_085_000)
            .saturating_add(DbWeight::get().reads(12))
    ...
    fn create_join_identity() -> Weight {
        ...
        Weight::from_ref_time(57_919_000)
    ...
    fn approve_join_identity() -> Weight {
        // Minimum execution time: 50_925 nanoseconds.
    ...
    fn remove_admin() -> Weight {
        // Minimum execution time: 23_784 nanoseconds.
        Weight::from_ref_time(24_175_000)
            .saturating_add(DbWeight::get().reads(4))
            .saturating_add(DbWeight::get().writes(1))
    }
}
