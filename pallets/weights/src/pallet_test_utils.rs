...
impl pallet_test_utils::WeightInfo for SubstrateWeight {
    ...
    fn register_did(i: u32) -> Weight {
        // Minimum execution time: 38_963 nanoseconds.
        Weight::from_ref_time(51_622_588)
            // Standard Error: 209_110
            .saturating_add(Weight::from_ref_time(10_693_288).saturating_mul(i.into()))
    ...
    fn mock_cdd_register_did() -> Weight {
        // Minimum execution time: 44_273 nanoseconds.
    ...
    fn get_my_did() -> Weight {
        ...
        Weight::from_ref_time(12_253_000).saturating_add(DbWeight::get().reads(1))
    }
    // Storage: Identity KeyRecords (r:1 w:0)
    // Proof Skipped: Identity KeyRecords (max_values: None, max_size: None, mode: Measured)
    // Storage: Timestamp Now (r:1 w:0)
    ...
    fn get_cdd_of() -> Weight {
        ...
        Weight::from_ref_time(28_935_000).saturating_add(DbWeight::get().reads(5))
    }
}
