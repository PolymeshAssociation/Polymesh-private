...
impl pallet_test_utils::WeightInfo for SubstrateWeight {
    ...
    fn register_did(i: u32) -> Weight {
        ...
        Weight::from_ref_time(37_377_208)
            // Standard Error: 350_049
            .saturating_add(Weight::from_ref_time(12_685_106).saturating_mul(i.into()))
    ...
    fn mock_cdd_register_did() -> Weight {
        ...
        Weight::from_ref_time(48_941_000)
            .saturating_add(DbWeight::get().reads(10))
    ...
    fn get_my_did() -> Weight {
        ...
        Weight::from_ref_time(13_004_000).saturating_add(DbWeight::get().reads(1))
    }
    // Storage: Identity KeyRecords (r:1 w:0)
    // Proof Skipped: Identity KeyRecords (max_values: None, max_size: None, mode: Measured)
    // Storage: Timestamp Now (r:1 w:0)
    ...
    fn get_cdd_of() -> Weight {
        ...
        Weight::from_ref_time(30_868_000).saturating_add(DbWeight::get().reads(5))
    }
}
