...
impl pallet_compliance_manager::WeightInfo for SubstrateWeight {
    ...
    fn condition_costs(a: u32, b: u32, c: u32, d: u32) -> Weight {
        // Minimum execution time: 7_173 nanoseconds.
        Weight::from_ref_time(7_524_000)
            // Standard Error: 40_225
            .saturating_add(Weight::from_ref_time(3_193_551).saturating_mul(a.into()))
            // Standard Error: 40_225
            .saturating_add(Weight::from_ref_time(287_615).saturating_mul(b.into()))
            // Standard Error: 40_225
            .saturating_add(Weight::from_ref_time(943_471).saturating_mul(c.into()))
            // Manually set for `d`
    ...
    fn add_compliance_requirement(c: u32) -> Weight {
        // Minimum execution time: 39_574 nanoseconds.
        Weight::from_ref_time(39_799_051)
            // Standard Error: 48_775
            .saturating_add(Weight::from_ref_time(1_336_139).saturating_mul(c.into()))
    ...
    fn remove_compliance_requirement() -> Weight {
        ...
        Weight::from_ref_time(58_690_000)
    ...
    fn pause_asset_compliance() -> Weight {
        // Minimum execution time: 38_422 nanoseconds.
        Weight::from_ref_time(60_684_000)
            .saturating_add(DbWeight::get().reads(5))
            .saturating_add(DbWeight::get().writes(1))
    }
    // Storage: Identity KeyRecords (r:1 w:0)
    ...
    fn resume_asset_compliance() -> Weight {
        // Minimum execution time: 29_826 nanoseconds.
        Weight::from_ref_time(30_517_000)
            .saturating_add(DbWeight::get().reads(5))
            .saturating_add(DbWeight::get().writes(1))
    }
    // Storage: Identity KeyRecords (r:1 w:0)
    ...
    fn add_default_trusted_claim_issuer() -> Weight {
        ...
        Weight::from_ref_time(36_609_000)
    ...
    fn remove_default_trusted_claim_issuer() -> Weight {
        // Minimum execution time: 28_384 nanoseconds.
    ...
    fn change_compliance_requirement(c: u32) -> Weight {
        ...
        Weight::from_ref_time(35_400_103)
            // Standard Error: 48_095
            .saturating_add(Weight::from_ref_time(1_711_217).saturating_mul(c.into()))
    ...
    fn replace_asset_compliance(c: u32) -> Weight {
        ...
        Weight::from_ref_time(36_670_428)
            // Standard Error: 118_254
            .saturating_add(Weight::from_ref_time(6_692_442).saturating_mul(c.into()))
            .saturating_add(DbWeight::get().reads(6))
            .saturating_add(DbWeight::get().writes(1))
    }
    // Storage: Identity KeyRecords (r:1 w:0)
    ...
    fn reset_asset_compliance() -> Weight {
        ...
        Weight::from_ref_time(24_586_000)
    ...
    fn is_condition_satisfied(c: u32, t: u32) -> Weight {
        ...
        Weight::from_ref_time(14_707_000)
            // Standard Error: 4_332
            .saturating_add(Weight::from_ref_time(3_561_454).saturating_mul(c.into()))
    ...
    fn is_identity_condition(e: u32) -> Weight {
        // Minimum execution time: 501 nanoseconds.
        Weight::from_ref_time(628_791)
            // Standard Error: 16_516
            .saturating_add(Weight::from_ref_time(6_681_875).saturating_mul(e.into()))
    ...
    fn is_any_requirement_compliant(i: u32) -> Weight {
        ...
        Weight::from_ref_time(39_964_665)
            // Standard Error: 1_594
            .saturating_add(Weight::from_ref_time(91_558).saturating_mul(i.into()))
    }
}
