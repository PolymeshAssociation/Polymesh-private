...
impl pallet_compliance_manager::WeightInfo for SubstrateWeight {
    ...
    fn condition_costs(a: u32, b: u32, c: u32, d: u32) -> Weight {
        ...
        Weight::from_ref_time(7_023_000)
            // Standard Error: 45_354
            .saturating_add(Weight::from_ref_time(3_177_697).saturating_mul(a.into()))
            // Standard Error: 45_354
            .saturating_add(Weight::from_ref_time(653_594).saturating_mul(b.into()))
            // Standard Error: 45_354
            .saturating_add(Weight::from_ref_time(878_427).saturating_mul(c.into()))
            // Manually set for `d`
    ...
    fn add_compliance_requirement(c: u32) -> Weight {
        // Minimum execution time: 43_232 nanoseconds.
        Weight::from_ref_time(42_902_330)
            // Standard Error: 34_431
            .saturating_add(Weight::from_ref_time(1_405_004).saturating_mul(c.into()))
    ...
    fn remove_compliance_requirement() -> Weight {
        // Minimum execution time: 33_383 nanoseconds.
        Weight::from_ref_time(33_623_000)
    ...
    fn pause_asset_compliance() -> Weight {
        ...
        Weight::from_ref_time(35_286_000)
            .saturating_add(DbWeight::get().reads(5))
            .saturating_add(DbWeight::get().writes(1))
    }
    // Storage: Identity KeyRecords (r:1 w:0)
    ...
    fn add_default_trusted_claim_issuer() -> Weight {
        // Minimum execution time: 40_406 nanoseconds.
    ...
    fn change_compliance_requirement(c: u32) -> Weight {
        // Minimum execution time: 39_294 nanoseconds.
        Weight::from_ref_time(39_327_393)
            // Standard Error: 25_030
            .saturating_add(Weight::from_ref_time(1_111_641).saturating_mul(c.into()))
    ...
    fn replace_asset_compliance(c: u32) -> Weight {
        ...
        Weight::from_ref_time(37_591_738)
            // Standard Error: 50_561
            .saturating_add(Weight::from_ref_time(8_243_649).saturating_mul(c.into()))
            .saturating_add(DbWeight::get().reads(6))
            .saturating_add(DbWeight::get().writes(1))
    }
    // Storage: Identity KeyRecords (r:1 w:0)
    ...
    fn reset_asset_compliance() -> Weight {
        // Minimum execution time: 25_498 nanoseconds.
        Weight::from_ref_time(26_390_000)
    ...
    fn is_condition_satisfied(c: u32, t: u32) -> Weight {
        ...
        Weight::from_ref_time(16_030_000)
            ...
            .saturating_add(Weight::from_ref_time(3_621_566).saturating_mul(c.into()))
            // Standard Error: 508_554
            .saturating_add(Weight::from_ref_time(4_378_843).saturating_mul(t.into()))
    ...
    fn is_identity_condition(e: u32) -> Weight {
        ...
        Weight::from_ref_time(607_799)
            // Standard Error: 12_213
            .saturating_add(Weight::from_ref_time(6_845_867).saturating_mul(e.into()))
    ...
    fn is_any_requirement_compliant(i: u32) -> Weight {
        ...
        Weight::from_ref_time(5_251_115)
            // Standard Error: 98
            .saturating_add(Weight::from_ref_time(96_224).saturating_mul(i.into()))
    }
}
