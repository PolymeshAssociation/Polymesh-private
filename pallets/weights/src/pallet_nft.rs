...
impl pallet_nft::WeightInfo for SubstrateWeight {
    ...
    fn create_nft_collection(n: u32) -> Weight {
        // Minimum execution time: 80_861 nanoseconds.
        Weight::from_ref_time(90_902_943)
            // Standard Error: 20_059
            .saturating_add(Weight::from_ref_time(1_720_455).saturating_mul(n.into()))
    ...
    fn issue_nft(n: u32) -> Weight {
        ...
        Weight::from_ref_time(44_579_600)
            // Standard Error: 15_690
            .saturating_add(Weight::from_ref_time(2_352_473).saturating_mul(n.into()))
    ...
    fn redeem_nft(n: u32) -> Weight {
        // Minimum execution time: 55_864 nanoseconds.
        Weight::from_ref_time(63_188_637)
            // Standard Error: 19_491
            .saturating_add(Weight::from_ref_time(3_349_583).saturating_mul(n.into()))
    ...
    fn base_nft_transfer(n: u32) -> Weight {
        // Minimum execution time: 90_971 nanoseconds.
        Weight::from_ref_time(84_159_577)
            // Standard Error: 47_437
            .saturating_add(Weight::from_ref_time(10_396_756).saturating_mul(n.into()))
            .saturating_add(DbWeight::get().reads(11))
    ...
    fn controller_transfer(n: u32) -> Weight {
        // Minimum execution time: 54_963 nanoseconds.
        Weight::from_ref_time(46_860_907)
            // Standard Error: 22_241
            .saturating_add(Weight::from_ref_time(10_103_645).saturating_mul(n.into()))
            .saturating_add(DbWeight::get().reads(9))
            .saturating_add(DbWeight::get().reads((2_u64).saturating_mul(n.into())))
            .saturating_add(DbWeight::get().writes(2))
            .saturating_add(DbWeight::get().writes((3_u64).saturating_mul(n.into())))
