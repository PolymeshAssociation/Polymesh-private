...
impl pallet_treasury::WeightInfo for SubstrateWeight {
    ...
    fn disbursement(b: u32) -> Weight {
        // Minimum execution time: 60_203 nanoseconds.
        Weight::from_ref_time(99_274_755)
            // Standard Error: 142_083
            .saturating_add(Weight::from_ref_time(33_871_217).saturating_mul(b.into()))
    ...
    fn reimbursement() -> Weight {
        // Minimum execution time: 50_355 nanoseconds.
        Weight::from_ref_time(51_416_000)
