...
impl pallet_committee::WeightInfo for SubstrateWeight {
    ...
    fn set_vote_threshold() -> Weight {
        ...
        Weight::from_ref_time(7_965_000).saturating_add(DbWeight::get().writes(1))
    }
    ...
    fn set_release_coordinator() -> Weight {
        // Minimum execution time: 19_085 nanoseconds.
        Weight::from_ref_time(19_256_000)
    ...
    fn set_expires_after() -> Weight {
        ...
        Weight::from_ref_time(7_615_000).saturating_add(DbWeight::get().writes(1))
    }
    ...
    fn vote_or_propose_new_proposal() -> Weight {
        // Minimum execution time: 86_031 nanoseconds.
        Weight::from_ref_time(91_361_000)
    ...
    fn vote_or_propose_existing_proposal() -> Weight {
        // Minimum execution time: 73_127 nanoseconds.
        Weight::from_ref_time(74_539_000)
    ...
    // Proof Skipped: Instance1Committee Proposals (max_values: Some(1), max_size: None, mode: Measured)
    fn vote_aye() -> Weight {
        // Minimum execution time: 172_223 nanoseconds.
        Weight::from_ref_time(174_637_000)
            .saturating_add(DbWeight::get().reads(7))
    ...
    // Proof Skipped: Instance1Committee VoteThreshold (max_values: Some(1), max_size: None, mode: Measured)
    fn vote_nay() -> Weight {
        // Minimum execution time: 62_046 nanoseconds.
        Weight::from_ref_time(64_661_000)
            .saturating_add(DbWeight::get().reads(4))
            .saturating_add(DbWeight::get().writes(1))
    }
}
