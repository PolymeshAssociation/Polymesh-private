...
impl pallet_identity::WeightInfo for SubstrateWeight {
    ...
    fn create_child_identities(i: u32) -> Weight {
        ...
        Weight::from_ref_time(73_113_109)
            // Standard Error: 92_662
            .saturating_add(Weight::from_ref_time(53_832_359).saturating_mul(i.into()))
    ...
    fn unlink_child_identity() -> Weight {
        ...
        Weight::from_ref_time(18_395_000)
    ...
    fn cdd_register_did(i: u32) -> Weight {
        ...
        Weight::from_ref_time(53_529_004)
            // Standard Error: 30_585
            .saturating_add(Weight::from_ref_time(9_253_911).saturating_mul(i.into()))
            .saturating_add(DbWeight::get().reads(8))
    ...
    fn invalidate_cdd_claims() -> Weight {
        ...
        Weight::from_ref_time(38_092_000)
    ...
    fn remove_secondary_keys(i: u32) -> Weight {
        ...
        Weight::from_ref_time(16_044_174)
            // Standard Error: 13_501
            .saturating_add(Weight::from_ref_time(9_504_033).saturating_mul(i.into()))
    ...
    fn accept_primary_key() -> Weight {
        ...
        Weight::from_ref_time(65_944_000)
    ...
    fn rotate_primary_key_to_secondary() -> Weight {
        ...
        Weight::from_ref_time(55_074_000)
    ...
    fn change_cdd_requirement_for_mk_rotation() -> Weight {
        ...
        Weight::from_ref_time(7_604_000).saturating_add(DbWeight::get().writes(1))
    }
    ...
    fn join_identity_as_key() -> Weight {
        // Minimum execution time: 52_739 nanoseconds.
        Weight::from_ref_time(53_290_000)
            .saturating_add(DbWeight::get().reads(9))
    ...
    fn leave_identity_as_key() -> Weight {
        ...
        Weight::from_ref_time(28_073_000)
    ...
    fn add_claim() -> Weight {
        ...
        Weight::from_ref_time(31_919_000)
            .saturating_add(DbWeight::get().reads(6))
            .saturating_add(DbWeight::get().writes(1))
    }
    // Storage: Identity KeyRecords (r:1 w:0)
    ...
    fn revoke_claim_by_index() -> Weight {
        ...
        Weight::from_ref_time(18_896_000)
            .saturating_add(DbWeight::get().reads(2))
            .saturating_add(DbWeight::get().writes(1))
    }
    // Storage: Identity KeyRecords (r:2 w:1)
    ...
    fn set_secondary_key_permissions() -> Weight {
        ...
        Weight::from_ref_time(20_278_000)
            .saturating_add(DbWeight::get().reads(2))
            .saturating_add(DbWeight::get().writes(1))
    }
    ...
    fn permissions_cost(a: u32, p: u32, l: u32, e: u32) -> Weight {
        // Minimum execution time: 215_494 nanoseconds.
        Weight::from_ref_time(215_915_000)
            // Manually set for `a`
            ...
            // Standard Error: 133_605
            .saturating_add(Weight::from_ref_time(10_950_502).saturating_mul(l.into()))
            // Standard Error: 133_605
            .saturating_add(Weight::from_ref_time(10_075_850).saturating_mul(e.into()))
    }
    // Storage: Identity KeyRecords (r:1 w:0)
    // Proof Skipped: Identity KeyRecords (max_values: None, max_size: None, mode: Measured)
    ...
    fn freeze_secondary_keys() -> Weight {
        ...
        Weight::from_ref_time(14_938_000)
            .saturating_add(DbWeight::get().reads(1))
            .saturating_add(DbWeight::get().writes(1))
    }
    // Storage: Identity KeyRecords (r:1 w:0)
    ...
    fn add_authorization() -> Weight {
        // Minimum execution time: 19_206 nanoseconds.
        Weight::from_ref_time(19_607_000)
            .saturating_add(DbWeight::get().reads(2))
            .saturating_add(DbWeight::get().writes(3))
    }
    // Storage: Identity KeyRecords (r:1 w:0)
    ...
    fn remove_authorization() -> Weight {
        ...
        Weight::from_ref_time(21_991_000)
            .saturating_add(DbWeight::get().reads(2))
            .saturating_add(DbWeight::get().writes(2))
    }
    // Storage: Identity KeyRecords (r:200 w:199)
    ...
    fn add_secondary_keys_with_authorization(i: u32) -> Weight {
        ...
        Weight::from_ref_time(60_240_019)
            // Standard Error: 68_590
            .saturating_add(Weight::from_ref_time(41_705_949).saturating_mul(i.into()))
            .saturating_add(DbWeight::get().reads(5))
            .saturating_add(DbWeight::get().reads((1_u64).saturating_mul(i.into())))
            .saturating_add(DbWeight::get().writes(1))
            .saturating_add(DbWeight::get().writes((2_u64).saturating_mul(i.into())))
    ...
    fn register_custom_claim_type(n: u32) -> Weight {
        ...
        Weight::from_ref_time(21_737_278)
            // Standard Error: 73
            .saturating_add(Weight::from_ref_time(3_450).saturating_mul(n.into()))
