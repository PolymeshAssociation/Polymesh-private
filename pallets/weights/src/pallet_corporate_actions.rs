...
impl pallet_corporate_actions::WeightInfo for SubstrateWeight {
    ...
    fn set_max_details_length() -> Weight {
        ...
        Weight::from_ref_time(2_976_000).saturating_add(DbWeight::get().writes(1))
    }
    ...
    fn set_default_targets(t: u32) -> Weight {
        // Minimum execution time: 14_136 nanoseconds.
        Weight::from_ref_time(16_248_409)
            // Standard Error: 369
            .saturating_add(Weight::from_ref_time(88_577).saturating_mul(t.into()))
    ...
    fn set_default_withholding_tax() -> Weight {
        ...
        Weight::from_ref_time(13_976_000)
            .saturating_add(DbWeight::get().reads(5))
            .saturating_add(DbWeight::get().writes(1))
    }
    // Storage: Identity KeyRecords (r:1 w:0)
    ...
    fn set_did_withholding_tax(w: u32) -> Weight {
        ...
        Weight::from_ref_time(19_281_280)
            // Standard Error: 414
            .saturating_add(Weight::from_ref_time(17_218).saturating_mul(w.into()))
            .saturating_add(DbWeight::get().reads(5))
            .saturating_add(DbWeight::get().writes(1))
    }
    // Storage: Identity KeyRecords (r:1 w:0)
    ...
    fn initiate_corporate_action_use_defaults(w: u32, t: u32) -> Weight {
        ...
        Weight::from_ref_time(47_336_464)
            // Standard Error: 392
            .saturating_add(Weight::from_ref_time(17_858).saturating_mul(w.into()))
            // Standard Error: 784
            .saturating_add(Weight::from_ref_time(9_250).saturating_mul(t.into()))
    ...
    fn initiate_corporate_action_provided(w: u32, t: u32) -> Weight {
        // Minimum execution time: 82_515 nanoseconds.
        Weight::from_ref_time(40_995_732)
            // Standard Error: 538
            .saturating_add(Weight::from_ref_time(52_073).saturating_mul(w.into()))
            // Standard Error: 1_076
            .saturating_add(Weight::from_ref_time(83_741).saturating_mul(t.into()))
    ...
    fn link_ca_doc(d: u32) -> Weight {
        ...
        Weight::from_ref_time(16_210_000)
            // Standard Error: 4_533
            .saturating_add(Weight::from_ref_time(1_591_130).saturating_mul(d.into()))
    ...
    fn remove_ca_with_ballot() -> Weight {
        // Minimum execution time: 30_938 nanoseconds.
    ...
    fn remove_ca_with_dist() -> Weight {
        // Minimum execution time: 33_813 nanoseconds.
        Weight::from_ref_time(34_835_000)
    ...
    fn change_record_date_with_ballot() -> Weight {
        ...
        Weight::from_ref_time(39_675_000)
