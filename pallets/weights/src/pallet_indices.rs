...
impl pallet_indices::WeightInfo for SubstrateWeight {
    ...
    fn claim() -> Weight {
        ...
        Weight::from_ref_time(16_341_000)
    ...
    fn transfer() -> Weight {
        ...
        Weight::from_ref_time(20_499_000)
    ...
    // Proof: Indices Accounts (max_values: None, max_size: Some(69), added: 2544, mode: MaxEncodedLen)
    fn free() -> Weight {
        // Minimum execution time: 16_862 nanoseconds.
        Weight::from_ref_time(17_212_000)
            .saturating_add(DbWeight::get().reads(1))
            .saturating_add(DbWeight::get().writes(1))
    }
    // Storage: Indices Accounts (r:1 w:1)
    ...
    fn force_transfer() -> Weight {
        ...
        Weight::from_ref_time(19_557_000)
            .saturating_add(DbWeight::get().reads(2))
            .saturating_add(DbWeight::get().writes(2))
    }
    // Storage: Indices Accounts (r:1 w:1)
    ...
    fn freeze() -> Weight {
        ...
        Weight::from_ref_time(15_609_000)
            .saturating_add(DbWeight::get().reads(1))
            .saturating_add(DbWeight::get().writes(1))
    }
}
