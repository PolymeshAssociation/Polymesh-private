...
impl pallet_asset::checkpoint::WeightInfo for SubstrateWeight {
    ...
    fn set_schedules_max_complexity() -> Weight {
        // Minimum execution time: 8_326 nanoseconds.
        Weight::from_ref_time(8_817_000).saturating_add(DbWeight::get().writes(1))
    }
    ...
    fn create_checkpoint() -> Weight {
        ...
        Weight::from_ref_time(41_548_000)
    ...
    fn create_schedule() -> Weight {
        // Minimum execution time: 55_083 nanoseconds.
        Weight::from_ref_time(56_395_000)
    ...
    fn remove_schedule() -> Weight {
        // Minimum execution time: 44_794 nanoseconds.
        Weight::from_ref_time(83_246_000)
            .saturating_add(DbWeight::get().reads(7))
            .saturating_add(DbWeight::get().writes(3))
    }
}
