...
impl pallet_asset::checkpoint::WeightInfo for SubstrateWeight {
    ...
    fn set_schedules_max_complexity() -> Weight {
        ...
        Weight::from_ref_time(13_205_000).saturating_add(DbWeight::get().writes(1))
    }
    ...
    fn create_checkpoint() -> Weight {
        // Minimum execution time: 71_094 nanoseconds.
        Weight::from_ref_time(72_045_000)
    ...
    fn create_schedule() -> Weight {
        // Minimum execution time: 56_025 nanoseconds.
        Weight::from_ref_time(57_498_000)
    ...
    fn remove_schedule() -> Weight {
        // Minimum execution time: 48_551 nanoseconds.
        Weight::from_ref_time(49_623_000)
            .saturating_add(DbWeight::get().reads(7))
            .saturating_add(DbWeight::get().writes(3))
    }
}
