...
impl pallet_asset::checkpoint::WeightInfo for SubstrateWeight {
    ...
    fn set_schedules_max_complexity() -> Weight {
        // Minimum execution time: 8_436 nanoseconds.
        Weight::from_ref_time(8_617_000).saturating_add(DbWeight::get().writes(1))
    }
    ...
    fn create_checkpoint() -> Weight {
        // Minimum execution time: 40_315 nanoseconds.
        Weight::from_ref_time(40_997_000)
    ...
    fn create_schedule() -> Weight {
        // Minimum execution time: 57_027 nanoseconds.
        Weight::from_ref_time(57_979_000)
    ...
    fn remove_schedule() -> Weight {
        // Minimum execution time: 49_894 nanoseconds.
        Weight::from_ref_time(89_608_000)
            .saturating_add(DbWeight::get().reads(7))
            .saturating_add(DbWeight::get().writes(3))
    }
}
