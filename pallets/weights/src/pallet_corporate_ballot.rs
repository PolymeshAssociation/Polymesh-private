...
impl pallet_corporate_actions::ballot::WeightInfo for SubstrateWeight {
    ...
    fn attach_ballot(c: u32) -> Weight {
        ...
        Weight::from_ref_time(55_248_959)
            // Standard Error: 3_092
            .saturating_add(Weight::from_ref_time(26_249).saturating_mul(c.into()))
    ...
    fn vote(c: u32, t: u32) -> Weight {
        // Minimum execution time: 70_673 nanoseconds.
        Weight::from_ref_time(69_354_376)
            // Standard Error: 718
            .saturating_add(Weight::from_ref_time(29_995).saturating_mul(c.into()))
            // Standard Error: 718
            .saturating_add(Weight::from_ref_time(7_770).saturating_mul(t.into()))
    ...
    fn change_end() -> Weight {
        ...
        Weight::from_ref_time(32_430_000)
    ...
    fn change_meta(c: u32) -> Weight {
        ...
        Weight::from_ref_time(37_085_467)
            // Standard Error: 1_856
            .saturating_add(Weight::from_ref_time(28_968).saturating_mul(c.into()))
            .saturating_add(DbWeight::get().reads(6))
            .saturating_add(DbWeight::get().writes(2))
    }
    // Storage: Identity KeyRecords (r:1 w:0)
    ...
    fn change_rcv() -> Weight {
        // Minimum execution time: 30_667 nanoseconds.
        Weight::from_ref_time(31_158_000)
            .saturating_add(DbWeight::get().reads(6))
            .saturating_add(DbWeight::get().writes(1))
    }
    // Storage: Identity KeyRecords (r:1 w:0)
