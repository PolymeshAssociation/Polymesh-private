...
impl pallet_corporate_actions::ballot::WeightInfo for SubstrateWeight {
    ...
    fn attach_ballot(c: u32) -> Weight {
        ...
        Weight::from_ref_time(49_952_353)
            // Standard Error: 1_430
            .saturating_add(Weight::from_ref_time(24_108).saturating_mul(c.into()))
    ...
    fn vote(c: u32, t: u32) -> Weight {
        // Minimum execution time: 87_054 nanoseconds.
        Weight::from_ref_time(68_242_316)
            // Standard Error: 667
            .saturating_add(Weight::from_ref_time(24_087).saturating_mul(c.into()))
            // Standard Error: 667
            .saturating_add(Weight::from_ref_time(23_227).saturating_mul(t.into()))
    ...
    fn change_end() -> Weight {
        // Minimum execution time: 56_285 nanoseconds.
        Weight::from_ref_time(58_339_000)
    ...
    fn change_meta(c: u32) -> Weight {
        ...
        Weight::from_ref_time(38_139_708)
            // Standard Error: 1_911
            .saturating_add(Weight::from_ref_time(31_824).saturating_mul(c.into()))
            .saturating_add(DbWeight::get().reads(6))
            .saturating_add(DbWeight::get().writes(2))
    }
    // Storage: Identity KeyRecords (r:1 w:0)
    ...
    fn change_rcv() -> Weight {
        ...
        Weight::from_ref_time(31_749_000)
            .saturating_add(DbWeight::get().reads(6))
            .saturating_add(DbWeight::get().writes(1))
    }
    // Storage: Identity KeyRecords (r:1 w:0)
    ...
    fn remove_ballot() -> Weight {
        // Minimum execution time: 61_325 nanoseconds.
        Weight::from_ref_time(63_579_000)
            .saturating_add(DbWeight::get().reads(6))
            .saturating_add(DbWeight::get().writes(4))
    }
}
