...
impl pallet_corporate_actions::ballot::WeightInfo for SubstrateWeight {
    ...
    fn attach_ballot(c: u32) -> Weight {
        // Minimum execution time: 45_275 nanoseconds.
        Weight::from_ref_time(46_892_708)
            // Standard Error: 2_990
            .saturating_add(Weight::from_ref_time(36_293).saturating_mul(c.into()))
    ...
    fn vote(c: u32, t: u32) -> Weight {
        // Minimum execution time: 79_139 nanoseconds.
        Weight::from_ref_time(55_661_790)
            // Standard Error: 457
            .saturating_add(Weight::from_ref_time(34_731).saturating_mul(c.into()))
            // Standard Error: 457
            .saturating_add(Weight::from_ref_time(27_551).saturating_mul(t.into()))
    ...
    fn change_end() -> Weight {
        ...
        Weight::from_ref_time(30_327_000)
    ...
    fn change_meta(c: u32) -> Weight {
        ...
        Weight::from_ref_time(38_157_567)
            // Standard Error: 2_646
            .saturating_add(Weight::from_ref_time(27_183).saturating_mul(c.into()))
            .saturating_add(DbWeight::get().reads(6))
            .saturating_add(DbWeight::get().writes(2))
    }
    // Storage: Identity KeyRecords (r:1 w:0)
    ...
    fn change_rcv() -> Weight {
        ...
        Weight::from_ref_time(29_164_000)
            .saturating_add(DbWeight::get().reads(6))
            .saturating_add(DbWeight::get().writes(1))
    }
    // Storage: Identity KeyRecords (r:1 w:0)
    ...
    fn remove_ballot() -> Weight {
        // Minimum execution time: 32_982 nanoseconds.
        Weight::from_ref_time(33_533_000)
            .saturating_add(DbWeight::get().reads(6))
            .saturating_add(DbWeight::get().writes(4))
    }
}
