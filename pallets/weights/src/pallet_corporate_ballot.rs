...
impl pallet_corporate_actions::ballot::WeightInfo for SubstrateWeight {
    ...
    fn attach_ballot(c: u32) -> Weight {
        ...
        Weight::from_ref_time(28_643_347)
            // Standard Error: 117
            .saturating_add(Weight::from_ref_time(23_980).saturating_mul(c.into()))
    ...
    fn vote(c: u32, t: u32) -> Weight {
        // Minimum execution time: 50_465 nanoseconds.
        Weight::from_ref_time(32_612_856)
            // Standard Error: 342
            .saturating_add(Weight::from_ref_time(50_592).saturating_mul(c.into()))
            // Standard Error: 342
            .saturating_add(Weight::from_ref_time(20_404).saturating_mul(t.into()))
    ...
    fn change_end() -> Weight {
        // Minimum execution time: 18_294 nanoseconds.
    ...
    fn change_meta(c: u32) -> Weight {
        ...
        Weight::from_ref_time(20_618_705)
            // Standard Error: 138
            .saturating_add(Weight::from_ref_time(25_696).saturating_mul(c.into()))
            .saturating_add(DbWeight::get().reads(6))
            .saturating_add(DbWeight::get().writes(2))
    }
    // Storage: Identity KeyRecords (r:1 w:0)
    ...
    fn change_rcv() -> Weight {
        ...
        Weight::from_ref_time(18_584_000)
            .saturating_add(DbWeight::get().reads(6))
            .saturating_add(DbWeight::get().writes(1))
    }
    // Storage: Identity KeyRecords (r:1 w:0)
