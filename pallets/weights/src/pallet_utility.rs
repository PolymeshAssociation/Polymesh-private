...
impl pallet_utility::WeightInfo for SubstrateWeight {
    ...
    fn batch(c: u32) -> Weight {
        ...
        Weight::from_ref_time(6_672_000)
            // Standard Error: 29_722
            .saturating_add(Weight::from_ref_time(10_636_282).saturating_mul(c.into()))
    ...
    fn batch_all(c: u32) -> Weight {
        // Minimum execution time: 6_643 nanoseconds.
        Weight::from_ref_time(104_861_064)
            // Standard Error: 34_417
            .saturating_add(Weight::from_ref_time(9_963_648).saturating_mul(c.into()))
            .saturating_add(DbWeight::get().reads(2))
            .saturating_add(DbWeight::get().writes(2))
    }
    ...
    fn force_batch(c: u32) -> Weight {
        // Minimum execution time: 6_002 nanoseconds.
        Weight::from_ref_time(20_260_354)
            // Standard Error: 70_062
            .saturating_add(Weight::from_ref_time(10_361_127).saturating_mul(c.into()))
            .saturating_add(DbWeight::get().reads(2))
            .saturating_add(DbWeight::get().writes(2))
    }
    ...
    fn relay_tx() -> Weight {
        ...
        Weight::from_ref_time(92_724_000)
    ...
    fn batch_old(c: u32) -> Weight {
        ...
        Weight::from_ref_time(12_657_998)
            // Standard Error: 92_912
            .saturating_add(Weight::from_ref_time(8_879_605).saturating_mul(c.into()))
            .saturating_add(DbWeight::get().reads(2))
            .saturating_add(DbWeight::get().writes(2))
    }
    // Storage: Permissions CurrentPalletName (r:1 w:1)
    ...
    fn batch_atomic(c: u32) -> Weight {
        ...
        Weight::from_ref_time(7_034_662)
            // Standard Error: 199_902
            .saturating_add(Weight::from_ref_time(9_505_497).saturating_mul(c.into()))
            .saturating_add(DbWeight::get().reads(2))
            .saturating_add(DbWeight::get().writes(2))
    }
    // Storage: Permissions CurrentPalletName (r:1 w:1)
    ...
    fn batch_optimistic(c: u32) -> Weight {
        // Minimum execution time: 6_993 nanoseconds.
        Weight::from_ref_time(13_586_919)
            // Standard Error: 125_650
            .saturating_add(Weight::from_ref_time(8_897_083).saturating_mul(c.into()))
            .saturating_add(DbWeight::get().reads(2))
            .saturating_add(DbWeight::get().writes(2))
    }
    // Storage: Identity KeyRecords (r:1 w:0)
    ...
    fn as_derivative() -> Weight {
        ...
        Weight::from_ref_time(24_066_000)
            .saturating_add(DbWeight::get().reads(5))
            .saturating_add(DbWeight::get().writes(4))
    }
}
