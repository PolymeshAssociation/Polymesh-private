...
impl pallet_group::WeightInfo for SubstrateWeight {
    ...
    fn set_active_members_limit() -> Weight {
        // Minimum execution time: 10_941 nanoseconds.
        Weight::from_ref_time(11_522_000)
    ...
    fn add_member() -> Weight {
        ...
        Weight::from_ref_time(48_651_000)
    ...
    fn disable_member() -> Weight {
        ...
        Weight::from_ref_time(54_733_000)
            .saturating_add(DbWeight::get().reads(4))
    ...
    fn swap_member() -> Weight {
        ...
        Weight::from_ref_time(66_525_000)
            .saturating_add(DbWeight::get().reads(4))
            .saturating_add(DbWeight::get().writes(3))
    }
    // Storage: Instance2Group ActiveMembersLimit (r:1 w:0)
    ...
    fn reset_members(m: u32) -> Weight {
        ...
        Weight::from_ref_time(35_847_000)
            // Standard Error: 15_641
            .saturating_add(Weight::from_ref_time(9_840_591).saturating_mul(m.into()))
            .saturating_add(DbWeight::get().reads(4))
    ...
    fn abdicate_membership() -> Weight {
        // Minimum execution time: 56_676 nanoseconds.
        Weight::from_ref_time(58_600_000)
            .saturating_add(DbWeight::get().reads(4))
            .saturating_add(DbWeight::get().writes(2))
    }
}
