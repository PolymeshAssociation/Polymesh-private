...
impl pallet_external_agents::WeightInfo for SubstrateWeight {
    ...
    fn create_group(p: u32) -> Weight {
        ...
        Weight::from_ref_time(28_856_075)
            // Standard Error: 18_698
            .saturating_add(Weight::from_ref_time(294_852).saturating_mul(p.into()))
    ...
    fn set_group_permissions(p: u32) -> Weight {
        ...
        Weight::from_ref_time(27_907_837)
            // Standard Error: 20_651
            .saturating_add(Weight::from_ref_time(462_356).saturating_mul(p.into()))
            .saturating_add(DbWeight::get().reads(5))
    ...
    fn remove_agent() -> Weight {
        ...
        Weight::from_ref_time(32_371_000)
    ...
    fn change_group_custom() -> Weight {
        ...
        Weight::from_ref_time(33_022_000)
    ...
    fn accept_become_agent() -> Weight {
        ...
        Weight::from_ref_time(50_655_000)
    ...
    fn create_group_and_add_auth(p: u32) -> Weight {
        // Minimum execution time: 38_061 nanoseconds.
        Weight::from_ref_time(40_920_262)
            // Standard Error: 24_064
            .saturating_add(Weight::from_ref_time(356_642).saturating_mul(p.into()))
            .saturating_add(DbWeight::get().reads(7))
            .saturating_add(DbWeight::get().writes(6))
    }
    // Storage: Identity KeyRecords (r:1 w:0)
    ...
    fn create_and_change_custom_group(p: u32) -> Weight {
        ...
        Weight::from_ref_time(43_025_838)
            // Standard Error: 48_535
            .saturating_add(Weight::from_ref_time(568_411).saturating_mul(p.into()))
            .saturating_add(DbWeight::get().reads(7))
