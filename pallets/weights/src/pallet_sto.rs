...
impl pallet_sto::WeightInfo for SubstrateWeight {
    ...
    fn create_fundraiser(i: u32) -> Weight {
        // Minimum execution time: 60_955 nanoseconds.
        Weight::from_ref_time(63_217_805)
            // Standard Error: 18_373
            .saturating_add(Weight::from_ref_time(53_157).saturating_mul(i.into()))
    ...
    fn invest() -> Weight {
        // Minimum execution time: 690_926 nanoseconds.
        Weight::from_ref_time(693_521_000)
            .saturating_add(DbWeight::get().reads(121))
    ...
    fn freeze_fundraiser() -> Weight {
        // Minimum execution time: 33_643 nanoseconds.
    ...
    fn unfreeze_fundraiser() -> Weight {
        // Minimum execution time: 32_681 nanoseconds.
        Weight::from_ref_time(33_393_000)
            .saturating_add(DbWeight::get().reads(5))
            .saturating_add(DbWeight::get().writes(1))
    }
    // Storage: Identity KeyRecords (r:1 w:0)
    ...
    fn modify_fundraiser_window() -> Weight {
        // Minimum execution time: 34_996 nanoseconds.
        Weight::from_ref_time(35_697_000)
    ...
    // Proof: Timestamp Now (max_values: Some(1), max_size: Some(8), added: 503, mode: MaxEncodedLen)
    fn stop() -> Weight {
        // Minimum execution time: 33_984 nanoseconds.
        Weight::from_ref_time(34_184_000)
