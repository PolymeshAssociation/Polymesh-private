...
impl pallet_sto::WeightInfo for SubstrateWeight {
    ...
    fn create_fundraiser(i: u32) -> Weight {
        ...
        Weight::from_ref_time(62_004_312)
            // Standard Error: 46_268
            .saturating_add(Weight::from_ref_time(253_732).saturating_mul(i.into()))
    ...
    fn invest() -> Weight {
        // Minimum execution time: 753_584 nanoseconds.
        Weight::from_ref_time(754_966_000)
    ...
    fn freeze_fundraiser() -> Weight {
        ...
        Weight::from_ref_time(31_789_000)
    ...
    fn unfreeze_fundraiser() -> Weight {
        ...
        Weight::from_ref_time(31_129_000)
            .saturating_add(DbWeight::get().reads(5))
            .saturating_add(DbWeight::get().writes(1))
    }
    // Storage: Identity KeyRecords (r:1 w:0)
    ...
    // Proof: Timestamp Now (max_values: Some(1), max_size: Some(8), added: 503, mode: MaxEncodedLen)
    fn stop() -> Weight {
        // Minimum execution time: 32_942 nanoseconds.
        Weight::from_ref_time(34_726_000)
