...
impl pallet_protocol_fee::WeightInfo for SubstrateWeight {
    ...
    fn change_coefficient() -> Weight {
        ...
        Weight::from_ref_time(7_293_000).saturating_add(DbWeight::get().writes(1))
    }
    ...
    fn change_base_fee() -> Weight {
        // Minimum execution time: 7_404 nanoseconds.
        Weight::from_ref_time(7_735_000).saturating_add(DbWeight::get().writes(1))
    }
}
