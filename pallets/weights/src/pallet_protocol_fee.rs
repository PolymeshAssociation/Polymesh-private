...
impl pallet_protocol_fee::WeightInfo for SubstrateWeight {
    ...
    fn change_coefficient() -> Weight {
        ...
        Weight::from_ref_time(8_866_000).saturating_add(DbWeight::get().writes(1))
    }
    ...
    fn change_base_fee() -> Weight {
        // Minimum execution time: 8_926 nanoseconds.
        Weight::from_ref_time(9_578_000).saturating_add(DbWeight::get().writes(1))
    }
}
