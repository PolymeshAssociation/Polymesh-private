...
impl pallet_relayer::WeightInfo for SubstrateWeight {
    ...
    fn set_paying_key() -> Weight {
        ...
        Weight::from_ref_time(25_137_000)
    ...
    fn accept_paying_key() -> Weight {
        ...
        Weight::from_ref_time(68_268_000)
    ...
    fn remove_paying_key() -> Weight {
        // Minimum execution time: 27_342 nanoseconds.
        Weight::from_ref_time(28_834_000)
    ...
    fn decrease_polyx_limit() -> Weight {
        ...
        Weight::from_ref_time(21_471_000)
            .saturating_add(DbWeight::get().reads(2))
            .saturating_add(DbWeight::get().writes(1))
    }
}
