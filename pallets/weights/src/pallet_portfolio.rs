...
impl pallet_portfolio::WeightInfo for SubstrateWeight {
    ...
    fn create_portfolio() -> Weight {
        ...
        Weight::from_ref_time(13_324_000)
    ...
    fn rename_portfolio(i: u32) -> Weight {
        // Minimum execution time: 12_995 nanoseconds.
        Weight::from_ref_time(13_591_819)
            // Standard Error: 141
            .saturating_add(Weight::from_ref_time(9_043).saturating_mul(i.into()))
            .saturating_add(DbWeight::get().reads(3))
            .saturating_add(DbWeight::get().writes(3))
    }
    // Storage: Identity KeyRecords (r:1 w:0)
    ...
    fn quit_portfolio_custody() -> Weight {
        // Minimum execution time: 11_862 nanoseconds.
        Weight::from_ref_time(12_122_000)
    ...
    fn move_portfolio_funds(f: u32, n: u32) -> Weight {
        // Minimum execution time: 96_802 nanoseconds.
        Weight::from_ref_time(10_228_176)
            // Standard Error: 106_028
            .saturating_add(Weight::from_ref_time(8_655_256).saturating_mul(f.into()))
            // Standard Error: 9_963
            .saturating_add(Weight::from_ref_time(5_175_792).saturating_mul(n.into()))
    ...
    fn remove_portfolio_pre_approval() -> Weight {
        ...
        Weight::from_ref_time(11_141_000)
            .saturating_add(DbWeight::get().reads(3))
            .saturating_add(DbWeight::get().writes(1))
    }
    // Storage: Identity KeyRecords (r:1 w:0)
    ...
    fn revoke_create_portfolios_permission() -> Weight {
        ...
        Weight::from_ref_time(5_811_000)
            .saturating_add(DbWeight::get().reads(1))
            .saturating_add(DbWeight::get().writes(1))
    }
    // Storage: Identity KeyRecords (r:1 w:0)
    ...
    fn create_custody_portfolio() -> Weight {
        ...
        Weight::from_ref_time(17_012_000)
            .saturating_add(DbWeight::get().reads(4))
            .saturating_add(DbWeight::get().writes(5))
    }
}
