...
impl pallet_portfolio::WeightInfo for SubstrateWeight {
    ...
    fn create_portfolio() -> Weight {
        // Minimum execution time: 27_311 nanoseconds.
    ...
    fn delete_portfolio() -> Weight {
        // Minimum execution time: 48_631 nanoseconds.
        Weight::from_ref_time(49_072_000)
    ...
    fn rename_portfolio(i: u32) -> Weight {
        ...
        Weight::from_ref_time(29_543_065)
            // Standard Error: 1_766
            .saturating_add(Weight::from_ref_time(6_012).saturating_mul(i.into()))
            .saturating_add(DbWeight::get().reads(3))
            .saturating_add(DbWeight::get().writes(3))
    }
    // Storage: Identity KeyRecords (r:1 w:0)
    ...
    fn quit_portfolio_custody() -> Weight {
        ...
        Weight::from_ref_time(22_322_000)
    ...
    fn accept_portfolio_custody() -> Weight {
        // Minimum execution time: 33_733 nanoseconds.
        Weight::from_ref_time(34_033_000)
            .saturating_add(DbWeight::get().reads(3))
            .saturating_add(DbWeight::get().writes(5))
    }
    // Storage: Identity KeyRecords (r:1 w:0)
    ...
    fn move_portfolio_funds(f: u32, n: u32) -> Weight {
        // Minimum execution time: 212_328 nanoseconds.
        Weight::from_ref_time(102_335_004)
            // Standard Error: 919_574
            .saturating_add(Weight::from_ref_time(13_934_444).saturating_mul(f.into()))
            // Standard Error: 86_410
            .saturating_add(Weight::from_ref_time(8_364_953).saturating_mul(n.into()))
    ...
    fn pre_approve_portfolio() -> Weight {
        ...
        Weight::from_ref_time(22_582_000)
            .saturating_add(DbWeight::get().reads(3))
            .saturating_add(DbWeight::get().writes(1))
    }
    // Storage: Identity KeyRecords (r:1 w:0)
    ...
    fn remove_portfolio_pre_approval() -> Weight {
        // Minimum execution time: 21_991 nanoseconds.
        Weight::from_ref_time(22_312_000)
            .saturating_add(DbWeight::get().reads(3))
            .saturating_add(DbWeight::get().writes(1))
    }
    // Storage: Identity KeyRecords (r:1 w:0)
    ...
    fn allow_identity_to_create_portfolios() -> Weight {
        ...
        Weight::from_ref_time(11_221_000)
    ...
    fn revoke_create_portfolios_permission() -> Weight {
        ...
        Weight::from_ref_time(11_571_000)
            .saturating_add(DbWeight::get().reads(1))
            .saturating_add(DbWeight::get().writes(1))
    }
    // Storage: Identity KeyRecords (r:1 w:0)
    ...
    fn create_custody_portfolio() -> Weight {
        ...
        Weight::from_ref_time(36_879_000)
            .saturating_add(DbWeight::get().reads(4))
            .saturating_add(DbWeight::get().writes(5))
    }
}
